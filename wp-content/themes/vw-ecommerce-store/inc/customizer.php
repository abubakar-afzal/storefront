...
function vw_ecommerce_store_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control('vw_ecommerce_store_location',array(
	 ...
	 $wp_customize->add_setting( 'vw_ecommerce_store_order_tracking',
       array(
          'default' => 1,
          'transport' => 'refresh',
          'sanitize_callback' => 'vw_ecommerce_store_switch_sanitization'
    ));  
    $wp_customize->add_control( new VW_Ecommerce_Store_Toggle_Switch_Custom_Control( $wp_customize, 'vw_ecommerce_store_order_tracking',
       array(
          'label' => esc_html__( 'On / Off Order Tracking','vw-ecommerce-store' ),
          'section' => 'vw_ecommerce_store_topbar'
    )));

    $wp_customize->add_setting( 'vw_ecommerce_store_header_search',
       array(
          'default' => 1,
          'transport' => 'refresh',
          'sanitize_callback' => 'vw_ecommerce_store_switch_sanitization'
    ));  
    $wp_customize->add_control( new VW_Ecommerce_Store_Toggle_Switch_Custom_Control( $wp_customize, 'vw_ecommerce_store_header_search',
       array(
