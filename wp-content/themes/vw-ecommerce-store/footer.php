...
?>
        ...
        <div id="footer-2">
          	<div class="copyright container">
                <p><?php echo esc_html(get_theme_mod('vw_ecommerce_store_footer_text',__('&copy; Copyright 2019 -','vw-ecommerce-store'))); ?> <?php vw_ecommerce_store_credit(); ?></p>
                <?php $theme_lay = get_theme_mod( 'vw_ecommerce_store_scroll_top_alignment','Right');
                if($theme_lay == 'Left'){ ?>
